...
Why offline mode specifically: this project's `alembic/env.py` always
generates SQL against `Settings.sqlalchemy_database_uri` (a PostgreSQL URL,
even in offline mode — the dialect determines SQL syntax, no connection is
